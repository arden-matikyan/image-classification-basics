...
class TwoLayerNet(object):
    ...
    def __init__(
        ...
        # first layer bias the size of hidden dimensions (neurons) amd the weights random using the weight scale, centered at 0 
        self.params['b1'] = np.zeros(hidden_dim)
        # rows = input dimensions, cols = hidden dimensions 
        self.params['W1'] = np.random.normal(0.0, weight_scale, (input_dim, hidden_dim))

        self.params['b2'] = np.zeros(num_classes)
        # rows =hidden dimensions , cols = number of classes 
    ...
    def loss(self, X, y=None):
        ...
        d_z1, d_W2, d_b2 = affine_backward(d_scores, z2_cache)
